...
class com.scaleform.sf2.lobby.Enchant.TreeViewDataProvider extends EventDispatcher {
	...
	private function preProcess(node:Object, parent:Object, depth:Number, depthIcons:Array):Void {
		...
		node.type = (node.nodes) ? TreeViewConstants.TYPE_OPEN : TreeViewConstants.TYPE_LEAF;
		var nodes:Array = node.nodes;
		if (nodes) {

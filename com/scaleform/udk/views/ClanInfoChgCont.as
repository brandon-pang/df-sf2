...
class com.scaleform.udk.views.ClanInfoChgCont extends UIComponent
{
    public var appBtn:Button;
    ...
    public function ClanInfoChgCont() {         
        super();  
    }
	...
	public function SetMapData($mapName:String,$mapImg:String){
		trace ("ClanInfoChgCont MapData wnd"+[$mapName,$mapImg])
	...
	private function onDropDownHandler(e:Object){		
		...
		ExternalInterface.call("clanInfoChg_dropdown_values",n,selNo)
	}
	private function onTextInputFocusInHandler(e:Object){
		var n=e.target._name
		ExternalInterface.call("clanInfoChg_textinput_focusin",n)
	}
	private function onTextInputFocusOutHandler(e:Object){
		var n=e.target._name
		ExternalInterface.call("clanInfoChg_textinput_focusout",n)
	}
	private function onTextInputChgHandler(e:Object){
		var n=e.target._name
		var txt=e.target.text
		ExternalInterface.call("clanInfoChg_textinput_chg",n,txt)
	}

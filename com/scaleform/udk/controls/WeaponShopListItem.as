...
class com.scaleform.udk.controls.WeaponShopListItem extends ListItemRenderer {
	...
	public function WeaponShopListItem() {
		super();
	}
	...
	private function lvLoader() {
		...
		var itemName:String = data.IconImg;
	...
	private function onChkOverHandler(e:Object) {
		_global.OnWeaponShopChkOverData(this._parent._parent._parent._id,this.index);
	...
	private function onChkOutHandler(e:Object) {
		_global.OnWeaponShopChkOutData(this._parent._parent._parent._id,this.index);
		var _level0 = _parent._parent._parent._parent._parent._parent._parent._parent._parent._parent;
		if (_Limitedclass != "" && _Limitedclass != undefined) {

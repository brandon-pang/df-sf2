...
[InspectableList("disabled", "visible", "labelID", "disableConstraints")]
 class com.scaleform.udk.controls.CamoListItem extends ListItemRenderer
{
	...
	private var urlPath = "";
	//private var urlPath="";
	//private var IconImgPath:String = urlPath+"gfx_imgset_weapon.swf";
	private var camoBgPath:String = urlPath + "gfx_imgset_camo_bg.swf";
	private var _hit:MovieClip;
	private var _boo:Boolean;
	private var _camobg:String;
	private var _CamoDay:String;
	private var contentsListName:String;
	public function CamoListItem()
	{
		super();
		contentsListName=this._parent._parent._parent._parent._parent._parent._parent._name
	}
	...
	private function onChkHandler(e:Object)
	{
		...
		trace (this._parent._parent._parent._parent._parent._parent._parent._name);
		
		_global[contentsListName+"_OnClick"](this._parent._parent._parent._id,this.index);
		//
	...
	private function onDblChkHandler(e:Object)
	{
		...
		_global[contentsListName+"_OnDblClick"](this._parent._parent._parent._id,this.index);
		root.weaponDp[this._parent._parent._parent._id].dataProvider[this.index].Chk = selNo;
		trace("targetPath = " + selNo);
	}
	...
	private function onChkOverHandler(e:Object)
	{
		...
		txtBg._visible = true;		
		_global[contentsListName+"_OnOver"](this._parent._parent._parent._id,this.index,_boo);
	...
	private function onChkOutHandler(e:Object)
	{
		...
		_global[contentsListName+"_OnOut"](this._parent._parent._parent._id,this.index,_boo);

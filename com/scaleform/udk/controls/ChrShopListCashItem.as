...
[InspectableList("disabled", "visible", "labelID", "disableConstraints")]
 class com.scaleform.udk.controls.ChrShopListCashItem extends ListItemRenderer
{
	...
	public function ChrShopListCashItem()
	{
		super();
	}
	...
	private function updateAfterStateChange():Void
	{
		...
		if(data.IconImg==undefined||data.IconImg==""){
			modeIcon._visible=false
		}else{
			modeIcon._visible=true
			//mcLoader.loadClip(IconImgPath,modeIcon);
	...
	private function onChkHandler(e:Object)
	{
		...
		_global.OnChrShopCashItemChkData(this._parent._parent._parent._id,this.index,boo);		
	}
	private function onDblChkHandler(e:Object){
		...
		_global.OnChrShopCashItemChkDblData(this._parent._parent._parent._id,this.index);
	}

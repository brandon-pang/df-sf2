...
[InspectableList("disabled", "visible", "labelID", "disableConstraints")]
 class com.scaleform.udk.controls.SlotItemRenderer_pve extends ListItemRenderer
{

	public var addFriendIcon:MovieClip;
	public var addFriendTxt:TextField;
	...
	// Initialization:
	public function SlotItemRenderer_pve()
	{
		super();
	...
	private function UpdateTextFields()
	{
		...
		if (_lock == 0)
		{
			...
			addFriendIcon.gotoAndStop(1);
			addFriendTxt._visible = false;
			if (_codename != "")
			{
				setVisible(true);
			...
			{
				addFriendIcon.gotoAndPlay("show");
				addFriendTxt._visible = true;
				numbericon._visible = false;
				setVisible(false);

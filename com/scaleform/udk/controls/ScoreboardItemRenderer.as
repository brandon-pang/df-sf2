...
[InspectableList("disabled", "visible", "labelID", "disableConstraints")]
 class com.scaleform.udk.controls.ScoreboardItemRenderer extends ListItemRenderer {
	...
	private function UpdateTextFields() {
		...
		if (_medeath == "1") {
			fontColor = "<font color='#000000' ALPHA='#90'>";
		} else {
		...
		score.htmlText = fontColor+_score+fontEnd;
		kill.htmlText = fontColor+_kill+" / "+_assist+" / "+_death+fontEnd;

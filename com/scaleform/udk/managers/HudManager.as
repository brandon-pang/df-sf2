...
class com.scaleform.udk.managers.HudManager extends UIComponent
{
	...
	private var Cursor_M:MovieClip;
	...
	public function HudManager()
	{
		...
		_tweenInitParams = {_alpha:0, _x:750};
	}
	...
	private function pushViewImpl(targetView:View, pushParams:Object):Void
	{
		...
		pushedContainer._x = pushParams.x
		...
		pushedContainer.tweenTo(0.5,{_alpha:100, _x:0},Strong.easeOut);
		pushedContainer.target = {x:0};
		...
		container.tweenTo(0.5,{_alpha:100, _x:targetX},Strong.easeOut);
	...
	private function popViewImpl(targetView:View,popParams:Object):Void
	{
        ...
        var tarMc:MovieClip=targetView["container"]
		if(tarMc["log_in"]){
			tarMc["log_in"].gotoAndPlay("close")
		}
		if(tarMc["dialog"]){

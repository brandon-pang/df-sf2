...
class com.scaleform.PveScoreBoardCont extends UIComponent
{
    ...
    public function PveScoreBoardCont()
    {         
        super();  
    }
							...
							_shooterMode):Void
	{
		...
		if(_shooterMode==null||_shooterMode=="1"){
			txt_kill.text="_pve_result_killset"
		}else{
			txt_kill.text="_shooter_result_killset"
		}
	}

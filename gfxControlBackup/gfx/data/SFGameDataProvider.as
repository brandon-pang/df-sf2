...
class gfx.data.SFGameDataProvider extends EventDispatcher {
	
	public var length = 0;
	private var bindingName:String;
	
	public function SFGameDataProvider(binding:String) { 
		super();		
		bindingName = binding;
		ExternalInterface.call("datastore_bind", bindingName, this);
	}
	...
	public function requestItemAt(index:Number, scope:Object, callBack:String):Void {
		ExternalInterface.call("datastore_requestItemAt", bindingName, index, scope, callBack);
	}
	...
	public function requestItemRange(startIndex:Number, endIndex:Number, scope:Object, callBack:String):Void {
		ExternalInterface.call("datastore_requestItemRange", bindingName, startIndex, endIndex, scope, callBack);
	}
	...
	public function toString():String {
		return "[SFGameDataProvider (" + length + ")]";
	}
}

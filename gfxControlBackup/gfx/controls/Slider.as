...
// Private Properties:
	...
	private var linePressed:Boolean = false;
...
// Public Methods:
	...
	public function set disabled(value:Boolean):Void {
		...
		thumb.disabled = track.disabled=line.disabled = _disabled;	
		invalidate();
	}		
...
// Private Methods:
	private function configUI():Void {
		...
		line.addEventListener("press", this, "trackPress");
		thumb.focusTarget = track.focusTarget=line.focusTarget = this;
		thumb.disabled = track.disabled=line.disabled = _disabled;	
	...
	private function updateThumb():Void {
		...
		line._width=thumb._x+(thumb._width/2)
	}	

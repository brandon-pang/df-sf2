...
// Public Methods:
	...
	public function close():Void {
		...
		Mouse.removeListener(_dropdown);
	...
	public function invalidateData():Void {
		...
		// 20120316 senariel begin - 데이터 갱신 시 rowCount 재계산 하도록
		if( _dropdown != null && _dataProvider.length != _dropdown.rowCount )
		{
			...
			{
				_dropdown.removeMovieClip();		// 다시 오픈할 때 
			}
		}
		// 20120316 senariel end
	}
...
// Private Methods:
	...
	private function changeFocus():Void {
		super.changeFocus();
		if( !_focused && isOpen && _dropdown != null ) { close(); }
	}

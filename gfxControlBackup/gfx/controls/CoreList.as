...
// Public Properties:
	...
	private var _scrollWheelDisabled:Boolean = false;
...
// Initialization:
	...
	public function CoreList() { 
		...
		var scrollWheelTarget:MovieClip = attachMovie("ScrollWheelTarget", "scrollWheelTarget", 2);
		if (scrollWheelTarget)
		{
			scrollWheelTarget._width = this._width * 100 / this._xscale;
			scrollWheelTarget._height = this._height * 100 / this._yscale;
			scrollWheelTarget._alpha = 0;
		}
	}
...
// Public Methods:
	...
	public function get scrollWheelDisabled():Boolean { return _scrollWheelDisabled; }
	public function set scrollWheelDisabled(value:Boolean):Void {        
		if (_scrollWheelDisabled == value) { return; }		
		_scrollWheelDisabled = value;
		//if (value) { Mouse.removeListener(this); }
		//else { Mouse.addListener(this); }
	}

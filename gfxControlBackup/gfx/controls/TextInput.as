...
// Constants:
	...
	public static function get focusState():Boolean {return _focusState; }
	public static function set focusState(value:Boolean):Void
	{
		_focusState = value;
	}

    private static var _focusState:Boolean = false;
...
// Initialization:
	...
	public function TextInput() { 
		...
		this.addEventListener("focusIn", this, "handlePathInputFocus");
		this.addEventListener("focusOut", this, "handlePathInputFocusOut");
	}
...
// Private Methods:
	...
	private function handlePathInputFocus(e:Object):Void
	{
		focusState = true;
		onMouseDown = checkPathInputFocus;
	}
	
	private function handlePathInputFocusOut():Void
	{
		focusState = false;
	}
	
	private function checkPathInputFocus():Void
	{
		var check:Object = Mouse["getTopMostEntity"](true);
		
		if(this != check && this.textField != check){

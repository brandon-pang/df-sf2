...
[InspectableList("disabled", "disableFocus", "visible", "toggle", "labelID", "disableConstraints", "enableInitCallback", "autoSize", "soundMap", "tooltip", "tooltipMulti")]
...
// Public Properties:
	...
	/** TooltipMulti */
	public var _tooltipMulti:String;
...
// Public Methods:
	...
	public function set tooltip(value:String):Void {
		...
		if (state == "over")
		{
			...
			{
				Tooltip.show(this, "SingleRowTooltip", {message:_tooltip});
			}
			else
			{
				Tooltip.hide();
	...
	[Inspectable(type="String", defaultValue="")]
	public function get tooltipMulti():String { return _tooltipMulti; }
	public function set tooltipMulti(value:String):Void {
		_tooltipMulti = value;
		if (state == "over")
		{
			if (_tooltipMulti != null && _tooltipMulti != "")
			{
				Tooltip.show(this, "MultiRowTooltip", {message:_tooltipMulti});
			}
			else
			{
				Tooltip.hide();
...
// Private Methods:
	...
	private function handleMouseRollOver(controllerIdx:Number):Void {
		...
		if (_tooltip != null && _tooltip != "") { Tooltip.show(this, "SingleRowTooltip", {message:_tooltip}); }
		else if (_tooltipMulti != null && _tooltipMulti != "") { Tooltip.show(this, "MultiRowTooltip", {message:_tooltipMulti}); }
	...
	private function handleMouseRollOut(controllerIdx:Number):Void {
		...
		if (_tooltip != null && _tooltip != "") { Tooltip.hide(); }
		else if (_tooltipMulti != null && _tooltipMulti != "") { Tooltip.hide(); }
